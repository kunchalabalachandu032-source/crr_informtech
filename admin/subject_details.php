...
<title><?php echo htmlspecialchars($subject); ?> Details | CRR-INFORMTECH</title>
...
<div class="header-box">
    <div class="back-top">
        <a href="subjects.php?year=<?php echo urlencode($year); ?>&section=<?php echo urlencode($section); ?>" class="btn-back">
    ...
    <p>Department of Information Technology | CRR-INFORMTECH</p>
</div>
    ...
    <div class="resources-grid">
        ...
        <?php if (strtolower($type) === 'lab'): ?>
            ...
            <div class="card-resource-clean">
                ...
                <a href="observations.php?year=<?php echo urlencode($year); ?>&section=<?php echo urlencode($section); ?>&subject=<?php echo urlencode($subject); ?>" class="btn-open-clean">
            ...
            <div class="card-resource-clean">
                ...
                <a href="record_pdf.php?year=<?php echo urlencode($year); ?>&section=<?php echo urlencode($section); ?>&subject=<?php echo urlencode($subject); ?>" class="btn-open-clean">
        ...
        <?php else: ?>
            ...
            <div class="card-resource-clean">
                ...
                <a href="works.php?year=<?php echo urlencode($year); ?>&section=<?php echo urlencode($section); ?>&subject=<?php echo urlencode($subject); ?>" class="btn-open-clean">
            ...
            <div class="card-resource-clean">
                ...
                <a href="assignments.php?year=<?php echo urlencode($year); ?>&section=<?php echo urlencode($section); ?>&subject=<?php echo urlencode($subject); ?>" class="btn-open-clean">
            ...
            <div class="card-resource-clean">
                ...
                <a href="mid_marks.php?year=<?php echo urlencode($year); ?>&section=<?php echo urlencode($section); ?>&subject=<?php echo urlencode($subject); ?>" class="btn-open-clean">
            ...
            <div class="card-resource-clean">
                ...
                <a href="important_questions.php?year=<?php echo urlencode($year); ?>&section=<?php echo urlencode($section); ?>&subject=<?php echo urlencode($subject); ?>" class="btn-open-clean">
