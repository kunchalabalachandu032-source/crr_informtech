...
if ($year == "2") {
    $title = "2nd Year";
    $sections = ["IT2A", "IT2B", "IT2C"];
} elseif ($year == "3") {
    $title = "3rd Year";
    $sections = ["IT3A", "IT3B", "IT3C"];
} else {
...
<title><?php echo htmlspecialchars($title); ?> Sections | CRR-INFORMTECH</title>
...
.card-section-clean:hover .section-icon-box {
...
<div class="header-box">
    <div class="back-top">
        <a href="years.php" class="btn-back">
            <i class="fa-solid fa-arrow-left"></i> Academic Years
        </a>
    </div>

    <h1>Select Section (<?php echo htmlspecialchars($title); ?>)</h1>
        ...
        <?php foreach ($sections as $section): ?>
            <div class="card-section-clean">
                <div>
                    ...
                    <p>Manage Subjects, Class Works, Assignments, and Marks for <b><?php echo htmlspecialchars($section); ?></b>.</p>
                </div>

                <a href="subjects.php?year=<?php echo urlencode($year); ?>&section=<?php echo urlencode($section); ?>" class="btn-open-clean">
                    <i class="fa-solid fa-folder-open"></i> Open Section <?php echo htmlspecialchars($section); ?>
                </a>
            </div>
        <?php endforeach; ?>
    </div>
